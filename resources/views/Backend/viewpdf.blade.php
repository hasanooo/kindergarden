        ...
        <table class="table table-hover" style="width:90%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{url('download',$item->pdf)}}"><button class="btn"><i class="fa-solid fa-download text-success"></i></button></a></td>
                </tr>
                @empty
                <tr>
                    <td colspan="5" class="text-center">No Books yet</td>
                </tr>
                @endforelse
            </tbody>
        </table>
