        ...
        <table class="table table-hover" style="width:90%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-start">{{substr($item->description,0,70)}}</td>
                    <td class="text-start">{{$item->event_start}}</td>
                    <td class="text-start">{{$item->event_end}}</td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/delete_notice/{{$item->id}}"> <button class="btn btn-primary" @if(session('msg')) data-bs-dismiss="modal" @endif>Delete</button> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- <td><a href="/delete_story/{{$item->id}}"><button class="btn"><i class="fa-solid fa-trash text-danger"></i></button></a></td> -->
                    <td><a href="/edit_notice/{{$item->id}}"><button class="btn"><i class="fa-solid fa-pen-to-square text-primary"></i></button></a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
